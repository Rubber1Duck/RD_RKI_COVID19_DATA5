...
def f_update():
    ...
    dtypes = {"Datenstand": "object", "IdBundesland": "Int32", "IdLandkreis": "Int32", "AnzahlFall": "Int32", "AnzahlTodesfall": "Int32",
    ...
    try:
        ...
        fallzahlen_df = pd.read_csv(path_fallzahlen, usecols=dtypes.keys(), dtype=dtypes)
